    ...
    <div className='border border-gray-500 h-screen overflow-y-scroll scrollbar-thin' >
        <div className='sticky top-0 z-10 bg-gray-700 pb-2 p-4'>
            ...
            <div className='mt-6 w-full h-9 bg-gray-500 p-1 pl-4 pr-4 rounded-xl'>
                ...
                <input type="text" value={searchBtn} className='w-full bg-gray-500 p-1 px-14 rounded-xl outline-none text-[#ddd]' placeholder='Search' onChange={(e) => setSearchBtn(e.target.value)}/>
                {
                    searchBtn.trim() == ""
                    ? null
                    : <IoClose size={20} color='#bbb' className='absolute right-6 inline-block mt-1 cursor-pointer' onClick={() => {
                        setSearchBtn("")
                    }}/>
                }
            </div>
        ...
        <div> 
                ...
                {
                    friendsBtn && <Friends searchText={searchText}/>
                }
                {
                    requestBtn && <FriendRequest searchText={searchText}/>
                }
                {
                    sendReqBtn && <Sendreq searchText={searchText}/>
                }
        </div>
    </div>
  )
